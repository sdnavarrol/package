...
int i2s_mem_unmap(i2s_config_type* ptri2s_config)
{
	...
	if(ptri2s_config->pMMAPBufPtr[MAX_I2S_PAGE])
	{
		...
		ptri2s_config->pMMAPBufPtr[MAX_I2S_PAGE] = 0; // ALU: unmap is made twice
	}
